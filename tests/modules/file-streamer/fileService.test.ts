...
describe("FileService", () => {
    ...
    describe("streamFile", () => {
        ...
        it("should handle invalid range requests", () => {
            ...
            expect(fakeSocket.write).toHaveBeenCalledWith(expect.stringContaining("416 Range Not Satisfiable"));
            expect(fakeSocket.end).toHaveBeenCalled();
        });
        ...
        it("should start a stream for a valid file", () => {
            ...
            expect(fakeSocket.write).toHaveBeenCalledWith(expect.stringContaining("HTTP/1.1 206 Partial Content"));
        });
